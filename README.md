...
## Skill
This repo includes a skill that guides an AI agent to use Vexor effectively: [`skill/vexor-cli`](https://github.com/scarletkc/vexor/raw/refs/heads/main/skill/vexor-cli/SKILL.md).
